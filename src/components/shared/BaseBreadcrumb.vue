    ...
    <v-col cols="12" md="12">
      <v-card elevation="0" variant="text">
        <v-row no-gutters class="align-center">
          <v-col sm="12">
            <v-breadcrumbs :items="props.breadcrumbs" class="text-h6 pa-1 font-weight-medium mb-0 text-capitalize">
            ...
            <h3 class="text-h3 mt-1 mb-0 text-capitalize">{{ props.title }}</h3>
          </v-col>
        </v-row>
      </v-card>
    </v-col>
